...
2. 坏的
   ...
   - as well as 连接两个形容词
      ...
      - negative / dispassioned

      - terrible / disgusting / disgraceful
...
which 可以引导修饰前面整个句子的定语从句，和前面的句子之间用逗号隔开。

可以写在作文中任何一个陈述句的后面，但是推荐写在第二段分析原因的时候某个比较短的原因后面用来拉长句子。
```

- 好的坏的后面

   - which leaves us a deep impression

    - which provokes the public's widespreed concerns
...
The lower price of cars made in China becomes, the more Chinese would like to purchases them, which leaves businessmen a deep impression.
...
1. as everyone can see it

2. with the rapid advance of science and technology

3. in our contemporary society（目前）

4. in the general routine of everyday living（日常生活中）
...
```
让步状语从句可以写在作文任何一句话的旁边，但是推荐写在第二段分析原因的时候使用
```
...
```
只要作文中出现 adj/adv 的地方，都可以写成 so ... that ...

但是推荐写在第一段的最后一句话，引出文章中心的时候引用，或者第三段的第一句话文章总结的时候使用。
```

Life proves so short that it is a waste how to spend it.

Sth keeps so vital that the problem should have been brought into the spotlight（聚光灯）.

Sth becomes so fatal that the problem should have been brought into the spotlight（聚光灯）.

3. 分词做状语

```
把分词放在句子的主谓之间作为插入语来使用
...
A boy, smiling, is rushing to the destination.

A boy confident as well as vigorous, smiling in the center of the vivid cartoon, is rushing to the destination which becomes a new start.

一幅图一个主体两个动作的末模板：

- sb（定）, doing sth1（次要）+ 定/状, is doing sth2（主要）+ 定或状

The hotpot delicious as well as healthy, smoking in the center of the vivid cartoon, is full of cultures from different nations in the world.
...
```
本句型推荐写在第一段的最后一句话，第二段的第一句话或者第三段的第一句话主谓之间。
```
...
- never fail to（没有意思，表示强调，强调谓语）

```
可以写在任何一个肯定句的主谓之间，推荐写在（同插入语）
```
...
```
作文中所有的句子都可以写成强调句型，但是推荐写在（同插入语）
```

- It is ... that ...

I love the girl in the restaurant.

- 强调 I

   - It is I that love the girl in the restaurant.

- 强调 in the restaurant

   - It si in the restaurant that I love the girl.

- 强调 the girl

   - It is the girl that I love in the restaurant.
...
- Sth proves to 人 as solid foundation is to high skyscrapers.

- Sth is to 人 as the infinite blue sky is to flying eagles.

Sth 很严重

- Sth proves to 人 as intensive pain is to incurably ill patients.

- Sth proves to 人 as horrible nightmares are to innocent kids.
